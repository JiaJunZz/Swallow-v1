...
class Host(models.Model):
    ...
    manufactory = models.ForeignKey('Manufactory', on_delete=models.DO_NOTHING, verbose_name=u'制造商', null=True, blank=True, max_length=32)
    supplier = models.ForeignKey('Supplier', on_delete=models.DO_NOTHING, verbose_name=u'供应商', null=True, blank=True, max_length=32)
