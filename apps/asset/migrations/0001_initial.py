# Generated by Django 2.0.4 on 2018-06-07 20:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip_managemant', models.GenericIPAddressField(unique=True, verbose_name='管理IP')),
                ...
                ('sn', models.CharField(blank=True, max_length=128, null=True, unique=True, verbose_name='序列号SN')),
                ('asset_type', models.CharField(choices=[('服务器', '服务器'), ('虚拟机', '虚拟机'), ('防火墙', '防火墙'), ('路由器', '路由器'), ('路由器', '防火墙'), ('其他', '其他')], max_length=32, verbose_name='资产类型')),
